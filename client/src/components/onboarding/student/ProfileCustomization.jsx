...
const ProfileCustomization = () => {
  const navigate = useNavigate();
  const { updateRegistrationData } = useAuth(); // <-- get updater from context
  ...
  const onSubmit = (data) => {
    // Save thesisTitle and description to registration context
    updateRegistrationData({
      thesisTitle: data.thesisTitle,
      thesisDescription: data.description,
    });
    navigate("/onboarding/student/milestone");
  };
